...
#if (SMOOTH_SERVO == 1)
  servo1.attach(SERVO_0, SERVO_MIN_PULSE, SERVO_MAX_PULSE, servoPos[0]); // 600 и 2400 - длины импульсов, при которых серво крутит на 0 и 180. Также указываем стартовый угол
...
#if (SMOOTH_SERVO == 1)
  servo2.attach(SERVO_1, SERVO_MIN_PULSE, SERVO_MAX_PULSE, servoPos[1]); // аналогично
