...
void channelSett(int dir) {
  ...
  switch (arrowPos) {
    ...
    case 4:
      if (curMode == 0) {   // реле
        incr(&channels[currentChannel].relayType, dir, 3);
        currentLine = 4;
      ...
      switch (thisMode) {
        ...
        case 4:
          if (PID[curPWMchannel].setpoint >= 50)
            incr(&PID[curPWMchannel].setpoint, dir * 10, 255);
          else
            incr(&PID[curPWMchannel].setpoint, dir, 255);
          currentLine = 2;
          break;
    ...
    case 7:
      switch (thisMode) {
        ...
        case 2: // неделька
          ...
          break;
        case 4: incr(&PID[curPWMchannel].dT, 1, 255);
          currentLine = 3;
          break;
    ...
    if (backlState) {
      ...
      if (currentChannel >= 0) {
        ...
        if (arrowPos == 1 && navDepth == 1) { // нажатие на Back
          ...
          navDepth = 0;
          arrowPos = 2;
          if (channels[currentChannel].mode == 0 || channels[currentChannel].mode == 2) hms_to_s();
        }
        currentLine = 4;
        redrawScreen();
      }
