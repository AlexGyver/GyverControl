...
void leftHservice() {
  switch (arrowPos) {
    ...
    case 13: channelStatesServ[9] = false;
      ...
      break;
    case 14: comSensPeriod -= 1;
      if (comSensPeriod < 1) comSensPeriod = 1;
      currentLine = 3;
      break;
  }
}
...
void rightHsettings() {
  ...
  switch (arrowPos) {
    case 0:
      ...
      currentLine = 4;
      break;
    case 1: LCD_BACKL = true;
      currentLine = 0;
      break;
    case 2:
      if (BACKL_TOUT < 250) BACKL_TOUT += 5;
      else BACKL_TOUT = 255;
      backlTimer = millis();
      currentLine = 1;
      break;
    case 3:
      if (DRIVE_SPEED < 250) DRIVE_SPEED += 10;
      else DRIVE_SPEED = 255;
      currentLine = 1;
      break;
    case 4:
      if (SERVO1_SPEED < 250) SERVO1_SPEED += 5;
      else SERVO1_SPEED = 255;
      currentLine = 2;
      break;
    case 5:
      SERVO1_ACC += (float)0.1;
      if (SERVO1_ACC >= 1) SERVO1_ACC = 1;
      currentLine = 2;
      break;
    case 6:
      if (SERVO2_SPEED < 250) SERVO2_SPEED += 5;
      else SERVO2_SPEED = 255;
      currentLine = 3;
      break;
    case 7:
      SERVO2_ACC += (float)0.1;
      if (SERVO2_ACC >= 1) SERVO2_ACC = 1;
      currentLine = 3;
      break;
  }
}
void leftHsettings() {
  ...
  switch (arrowPos) {
    case 0:
      ...
      currentLine = 4;
      break;
    case 1: LCD_BACKL = false;
      currentLine = 0;
      break;
    case 2:
      if (BACKL_TOUT > 10) BACKL_TOUT -= 5;
      else BACKL_TOUT = 5;
      backlTimer = millis();
      currentLine = 1;
      break;
    case 3:
      if (DRIVE_SPEED > 10) DRIVE_SPEED -= 10;
      else DRIVE_SPEED = 5;
      currentLine = 1;
      break;
    case 4:
      if (SERVO1_SPEED > 10) SERVO1_SPEED -= 5;
      else SERVO1_SPEED = 5;
      currentLine = 2;
      break;
    case 5:
      SERVO1_ACC -= (float)0.1;
      if (SERVO1_ACC < 0.1) SERVO1_ACC = 0.1;
      currentLine = 2;
      break;
    case 6:
      if (SERVO2_SPEED > 10) SERVO2_SPEED -= 5;
      else SERVO2_SPEED = 5;
      currentLine = 3;
      break;
    case 7:
      SERVO2_ACC -= (float)0.1;
      if (SERVO2_ACC < 0.1) SERVO2_ACC = 0.1;
      currentLine = 3;
      break;
  }
}
          ...
          if (navDepth == 0) {
            ...
            switch (channels[currentChannel].mode) {
              ...
              case 2: if (++arrowPos > 3) arrowPos = 3;
                break;
              case 3: if (++arrowPos > 4) arrowPos = 4;
                break;
            }
          }
