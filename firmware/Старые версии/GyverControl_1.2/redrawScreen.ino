...
void redrawDebug() {
  ...
  lcd.setCursor(0, 2); lcd.print(F("T:")); lcd.print((int)(sensorVals[0]));
...
void redrawService() {
  ...
  if (currentLine == 1 || currentLine == 4) {
    ...
    lcd.setCursor(14, 1); lcd.print(F("S1:")); lcd.print((byte)(servoPosServ[0]));
  }
  if (currentLine == 2 || currentLine == 4) {
    clearLine2(2);
    ...
    lcd.setCursor(14, 2); lcd.print(F("S2:")); lcd.print((byte)(servoPosServ[1]));
  }
  if (currentLine == 3 || currentLine == 4) {
    clearLine2(3);
