...
// ======== СИСТЕМА =======
#define PLOTS 0             // 1 - включить, 0 - отключить вывод графиков
...
// цифровой датчик температуры и влажности DHT11/DHT22 (вход SENS2)
#define DHT_SENS2 0         // 1 - ко входу SENS2 подключен DHT11/DHT22, 0 - подключен обычный аналоговый датчик
#define DHTTYPE DHT22       // тип DHT датчика: DHT11 или DHT22
...
struct channelsStruct {
  ...
  boolean global = false;  // режим сутки + сенсор
